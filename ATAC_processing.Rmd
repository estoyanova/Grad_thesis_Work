...
bamCompare -b1 ATAC.sorted.dupsrem.bam -b2 chip.input.out.bam -o log2.name.to.input.1x.merged.bw --normalizeTo1x 2730871774 --minMappingQuality 30 --ignoreForNormalization chrX chrM chrY &
...
bedtools intersect -v -a my.bed -b mm10.blacklist.bed > my.filtered.bed

## Removing peaks from chrY and chrM

grep -v chrY my.filtered.bed | grep -v chrM > my.filtered.2.bed

...
``` 
bamCompare -b1 ATAC.sorted.dupsrem.bam -b2 input.out.bam -o log2.name.to.input.1x.merged.bw --normalizeUsingRPKM --minMappingQuality 30 --ignoreForNormalization chrX chrM chrY --blackListFileName ~/mm10.blacklist.bed -p 32 &
```
# Peak calling
#### Using macs2
```
